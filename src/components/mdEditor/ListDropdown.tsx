...
import { listOptions } from "@/constants/tiptapConstants";
...
export function ListDropdown({ editor }: Props) {
  const [open, setOpen] = useState(false);
  const current =
    listOptions.find((option) => option.isActive(editor)) || listOptions[0];
